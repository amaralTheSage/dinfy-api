...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_subscriptions', function (Blueprint $table) {
            ...
            $table->string('mercado_pago_preapproval_id')->nullable()->unique();
            $table->string('mercado_pago_payment_id')->nullable();
            $table->string('mercado_pago_authorized_payment_id')->nullable();
            ...
            $table->string('sandbox_checkout_url', 2048)->nullable();
